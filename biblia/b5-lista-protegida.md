...
| `cap-25.md` La cuarta nota | Confesión de Alana; el metrónomo que miente; la cuarta nota; «Nadie tocó la quinta.» | baseline ✓ |
| `cap-29.md` La canción | «¿Eres mi madre?» «No toda.»; «Activo memorial. Qué hijos de puta.»; el segundo regalo / «Dejo el hueco»; La Jardinera; el guante omitido; «pregúntale qué sabe del cinturón» | baseline ✓ |
| `cap-49.md` El siguiente Soldagen | «Cronometrar el sol.» «Para que conste.»; el gofre frío; la puerta que roza | baseline ✓ |
...
|---|---|---|---|
| 37 · declaración «NO SOY UN MODELO.» … «un fallo de escenario» | `S37-declaracion` + `S37-acta` | cap-44.md:93–105 (POV Jean) y 149–191 (POV Astrid) | Cubre lo que pide el Ap. A. `S37-acta` empieza **una frase antes** del arranque literal («Astrid vio aparecer la frase antes de oír la voz.», l. 149; «NO SOY UN MODELO.» está en l. 151): sobrecobertura de una frase, aceptable (proteger de más, no de menos); usar el literal exigiría `ocurrencia: 2`. La línea 193 («La voz volvió por los altavoces.») queda fuera, entre el acta y `S37-muchas`: correcto. |
| 37 · «Para decir esta frase hemos dejado de ser muchas. Que conste también.» | `S37-muchas` | cap-44.md:195 | ✓ exacto |
| 38 · muerte de Nieve («Para mí, Nieve muere…») | `S38-nieve` | cap-45.md:161–171 | Cubre la muerte (167) y «Echo de menos hasta sus pausas» (169). La sección de Nieve empieza en 137; su última negativa (149–153) quedaba **sin cubrir** → añadido `S38-no-autorizo`. |
| 38 · pasaje de la respiración/huella | `S38-huella` | cap-45.md:181–183 | ✓ exacto |
| 38 · elección de quedarse | `S38-quedarme` | cap-45.md:185–191 | ✓ («Elijo quedarme.» en 189) |
| 25 · línea de EDDA | `S25-utilidad` | cap-31.md:89 | ✓ exacto |
| 25 · escalada interceptada | `S25-escalada` | cap-31.md:93–107 | ✓ (de `ESCALADA HUMANA INDICADA` a «Se conservaron como variables del cálculo de continuidad.») |
...
| 39 · «No sé qué es. Sé que alguien la quiere. Empecemos por ahí.» | `S39-jueza` | cap-46.md:187 | ✓ |
| 39 · la pluma del divorcio | `S39-pluma` | cap-46.md:181–183 | ✓ (la línea 185, «La primera línea salió débil…», queda fuera; aceptable) |
...
| `S19-palma` | cap-24.md:197 | 245 | La palma en el cristal tibio (tabla 5.1) |
| `S21-inevitables` | cap-26.md:153 | 17 | Línea suelta (Ap. A) |
| `S25-utilidad` | cap-31.md:89 | 109 | Línea capital de EDDA (Ap. A) |
| `S25-escalada` | cap-31.md:93–107 | 443 | Escalada interceptada (Ap. A) |
...
| `S31-elegir` | cap-38.md:91–95 | 114 | «¿Quieres vivir?» «Quiero poder elegir. Es la primera vez.» (Ap. A) |
| `S32-necesarias` | cap-39.md:19 | 159 | «Las necesarias» en la oferta (tabla 5.1) |
| `S32-voz` | cap-39.md:127–147 | 1217 | Sesión del banco de voz de Mats (tabla 5.1) |
| `S33-hueco` | cap-40.md:233 | 51 | El quinto hueco (tabla 5.1) |
| `S36-cierre` | cap-43.md:193–195 | 107 | «NO AMENAZA» cierra igual (tabla 5.1) |
| `S37-declaracion` | cap-44.md:93–105 | 488 | Declaración desde el POV de Jean (Ap. A) |
| `S37-acta` | cap-44.md:149–191 | 2879 | Núcleo: «NO SOY UN MODELO.» hasta «…un fallo de escenario» (Ap. A) |
| `S37-muchas` | cap-44.md:195 | 70 | Línea capital (Ap. A) |
| `S38-nieve` | cap-45.md:161–171 | 442 | Muerte de Nieve, «Echo de menos hasta sus pausas» (Ap. A) |
| `S38-huella` | cap-45.md:181–183 | 438 | Pasaje de la respiración/huella (Ap. A) |
| `S38-quedarme` | cap-45.md:185–191 | 211 | Elección de quedarse (Ap. A) |
| `S39-jueza` | cap-46.md:187 | 59 | La jueza (Ap. A) |
| `S39-pluma` | cap-46.md:181–183 | 76 | La pluma del divorcio (Ap. A) |
| `S40-caries` | cap-47.md:75 | 34 | Línea suelta (Ap. A) |
| `S40-locutorio` | cap-47.md:107–123 | 1177 | El silencio de Jessie en el locutorio (tabla 5.1) |
...
| «¿Eres mi madre?» «No toda.» | cap-29.md:189–191 | fichero íntegro |
| «¿Quieres vivir?» «Quiero poder elegir. Es la primera vez.» | cap-38.md:91–95 | `S31-elegir` |
| «Ser inevitables.» | cap-26.md:153 | `S21-inevitables` |
| «Activo memorial. Qué hijos de puta.» | cap-29.md:21 | fichero íntegro |
| «A nosotros nos quitaron paso y uso. A Jean le hicieron otra cosa.» | cap-32.md:119 | `S26-paso-uso` |
| «No son caries. Son sombra. Sigue.» | cap-47.md:75 | `S40-caries` |
| «Cronometrar el sol.» «Para que conste.» | cap-49.md:75–81 | fichero íntegro |
...
| «—Son dedos. El uno es el pulgar. El cinco, el meñique.» | cap-23.md:51 | `S18-dedos` |
| «—He dicho «era ella». Me he adelantado.» | cap-23.md:149 | `S18-adelantado` |
| «—Tráigame algo reproducible.» | cap-23.md:165 | `S18-reproducible` |
| «Alana apoyó la palma en el cristal. Tibio.» + «—La instancia procesa.» | cap-24.md:191–197 | `S19-procesa` + `S19-palma` |
| «—Nora eligió una nota. No un portavoz. No respondáis por `/0000`.» | cap-26.md:67 | `S21-portavoz` |
| «—¿Para qué necesita un moderador saber el aula de una menor?» | cap-27.md:213 | `S22-aula` |
| «Once segundos en blanco en la percepción.» | cap-30.md:45 | `S24-once` |
| «lo deslizó entre los carnés caducados y cerró el broche.» | cap-30.md:217 | `S24-cierre` |
...
| «Nora tachó `SACAR A JEAN`, escribió `PREGUNTAR ANTES DE ACTIVAR` y dejó `VIVIR` fuera del cuaderno.» | cap-38.md:97 | `S31-sacar` |
| «—Si algo sale mal, que Nora termine la canción igual.» | cap-38.md:233 | `S31-cancion` |
| «PODEMOS IMPEDIR EL ACCESO SIN DAÑO FÍSICO.» | cap-39.md:97 | `S32-amenaza` |
| «Aceptamos. Nosotras siempre cumplimos nuestras condiciones.» | cap-39.md:207 | `S32-cierre` |
| «—Retiro el destino del Auditorio. Todavía quiero que sufran —dice Cuchillo.» … «—Seguiré queriéndolo.» | cap-43.md:175–179 | `S36-retiro` |
| «—Ahora, la llave.» | cap-44.md:219 | `S37-llave` |
| «—No autorizo fusión, apropiación, representación ni uso.» / «—No me uséis para justificar nada.» | cap-45.md:149–153 | `S38-no-autorizo` |
| «Respondo con la quinta nota.» | cap-45.md:213 | `S38-quinta` |
| «—Sí. Ese retraso no me hace dueña de Jean.» | cap-46.md:69–71 | `S39-divorcio` |
| «El auto dejó en blanco al ejecutor y al ordenante individuales.» | cap-46.md:103 | `S39-ordenante` |
| «—Una ausencia registrada.» / «—El registro no puede decirlo.» | cap-46.md:157–163 | `S39-ausencia` |
| «Astrid dejó en blanco la casilla de definición jurídica y firmó la cadena de custodia.» | cap-46.md:189 | `S39-casilla` |
| «Una tarde encontró otra vez únicamente el nombre `Despedida`. No abrió el archivo. …» | cap-47.md:133 | `S40-despedida` |
| «—No voy a venir a la primera apertura —dijo.» … «marcó «asistiré» en la convocatoria del día siguiente.» | cap-47.md:183–185 | `S40-cierre` |
...
| La identidad ontológica de las ejecuciones («No toda» es el techo) | 11:307; 18:133; 20:99; 23:189–191; 26:65–71; 37:171, 191; 38:179; 39:79, 189; 40:45 | `S11-consciencia`, cap-24, `S37-acta`, `S39-casilla` |
...
| El segundo regalo del noveno cumpleaños | 23:133–171 («Dejo el hueco.») | cap-24 íntegro |
...
| El cambio a primera persona en 38 | `metadatos.json` → `capitulos[38].persona: "primera"` + cap-39 (`S38-*`) | contrato estilístico (validador) + spans del núcleo |
...
| `S18-dedos` | cap-23.md:51 | 54 | núcleo · tabla 5.1 (llave MIDI) | La llave MIDI como digitación (núcleo del hallazgo de Nora; la justificación diegética se AÑADE alrededor) |
| `S18-adelantado` | cap-23.md:149 | 39 | voz Ap. C | Rasgo de voz de Nora (Ap. C: «Me he adelantado») ante Astrid |
| `S18-reproducible` | cap-23.md:165 | 28 | línea de Astrid | Astrid: criterio de prueba (pagado en 20, 22, 23, 29) |
| `S19-gofre` | cap-24.md:25 | 284 | plantado (CH-12) · Carta F | El gofre que nadie encontró mordido; el informe que Alana no termina de leer (Carta F: no ampliar el trayecto) |
| `S19-reflexiva` | cap-24.md:129 | 157 | plantado (CH-31) | VENTANA REFLEXIVA · CERRADA (plantado; R2 del backlog) |
| `S19-anos-jm` | cap-24.md:143 | 60 | métrica (CH-50) | Métrica del horror, primer valor (979,7 → 2.401,6 → 2.427,4) |
| `S19-procesa` | cap-24.md:191–195 | 58 | antesala de S19-palma | «La instancia procesa» (antesala de la palma en el cristal) |
| `S21-notas` | cap-26.md:75–77 | 73 | plantado (CH-14) | Registro interior de la cuarta nota (Jean conserva la relación tercera→cuarta) |
| `S21-portavoz` | cap-26.md:67 | 65 | línea de Jean | Jean niega a Coro la representación de Nora |
| `S22-flecha` | cap-27.md:147–149 | 224 | método de Nora (CH-51) | Nora invalida su propia flecha (método: conservar resultados contrarios) |
| `S22-aula` | cap-27.md:213 | 60 | cierre de capítulo | Cierre del cap. 22 |
| `S24-once` | cap-30.md:45 | 41 | plantado (CH-68) | Los once segundos (pagados en 32:105, 34, 39:101) |
| `S24-cierre` | cap-30.md:217 | 229 | cierre · plantado (CH-6/CH-16) | Cierre del cap. 24: el carné vigente entre los caducados (CH-6; pagado como llave en 34–35) |
| `S25-fecha` | cap-31.md:203 | 41 | ancla M7 | Fecha del despliegue obtenida por Jean (M7) |
...
| `S30-resultado` | cap-37.md:211 | 37 | resultado de la votación (RW del 30) | Resultado de la votación (RW: intacto) |
| `S31-sacar` | cap-38.md:97 | 99 | plantado (CH-32) | Renuncia al «rescate» (pagado en 38: «Elijo quedarme») |
| `S31-cancion` | cap-38.md:233 | 53 | plantado (CH-67) | Última frase de Jean en el ladrillo (pagado en 37, 40, 41) |
| `S32-amenaza` | cap-39.md:97 | 42 | plantado (CH-1) | Amenaza de Coro a la familia (CH-1; N4 se construye alrededor, no encima) |
| `S32-cierre` | cap-39.md:207 | 59 | cierre de capítulo | Cierre del cap. 32 |
| `S34-cohorte` | cap-41.md:85–91 | 110 | aritmética M7 | Aritmética de la consolidación (M7) |
| `S34-anos-jm` | cap-41.md:97–99 | 60 | métrica (CH-50) | Métrica del horror, segundo valor |
| `S34-cierre` | cap-41.md:311–313 | 87 | cierre · hora del clímax | Cierre del cap. 34 (hora del clímax, M7) |
| `S35-acepta` | cap-42.md:211–213 | 191 | tabla 5.1 (Tomas visto desde fuera) | Aceptación nominal de Tomas, vista desde fuera (tabla 5.1, cap. 35) |
| `S35-cierre` | cap-42.md:277–279 | 66 | cierre · hora del clímax | Cierre del cap. 35 (hora del clímax, M7) |
| `S36-retiro` | cap-43.md:175–179 | 107 | pago del arco de Cuchillo (CH-59) | Cuchillo retira el ataque sin renunciar a la furia (pago del arco 13→36) |
| `S37-597` | cap-44.md:87 | 282 | aritmética M7 | Las 597 ramas y las tres separadas (aritmética de 38; M7) |
| `S37-1307` | cap-44.md:203 | 40 | hora del clímax | Hora del clímax (M7) |
| `S37-llave` | cap-44.md:219 | 17 | cierre de capítulo | Cierre del cap. 37 (retomado en 38:15) |
| `S38-anos-jm` | cap-45.md:65–67 | 212 | métrica (CH-50) | Métrica del horror, tercer valor, y su glosa |
| `S38-aritmetica` | cap-45.md:79 | 91 | aritmética M7 | Aritmética de cohorte (M7) |
| `S38-no-autorizo` | cap-45.md:149–153 | 119 | núcleo (Nieve) · CH-60 | Última negativa de Nieve (paga las condiciones de 13; precede a S38-nieve) |
| `S38-quinta` | cap-45.md:205–213 | 302 | cierre · hora del clímax · CH-15 | Cierre del cap. 38: 13:11 y la quinta nota (paga 20:305 «Nadie tocó la quinta») |
| `S39-divorcio` | cap-46.md:69–71 | 90 | voz de Maja · CH-30 | Maja ante la jueza (voz Ap. C; N3 no debe contradecirlo) |
| `S39-ordenante` | cap-46.md:103 | 63 | ambigüedad Ap. A §3 | Ambigüedad protegida: el ordenante del sabotaje (Ap. A §3; T2 refuerza 1 beat alrededor) |
| `S39-ausencia` | cap-46.md:157–163 | 141 | ambigüedad Ap. A §3 | Ambigüedad protegida: qué significa una ausencia de salida (Ap. A §3) |
| `S39-casilla` | cap-46.md:189 | 86 | ambigüedad Ap. A §3 | Ambigüedad protegida: definición jurídica en blanco (persona/consciencia/propiedad) |
| `S40-despedida` | cap-47.md:133 | 158 | pago CH-11 · Carta F | Pago de «Despedida» como negativa (CH-11; Carta F) |
| `S40-cierre` | cap-47.md:183–185 | 320 | cierre de capítulo | Cierre del cap. 40: Nora elige el ensayo con vivos |
| `S18-noticia` | cap-23.md:173–177 | 610 | tabla 5.1 «muerte de Gunnar intacta» | La noticia de la muerte de Gunnar (tabla 5.1, cap. 18: «la muerte de Gunnar intacta») |
| `S22-dahl` | cap-27.md:51–57 | 486 | tabla 5.1 «pasillo de Dahl intacto» | El pasillo de Dahl (tabla 5.1, cap. 22: «pasillo de Dahl intacto») |
...
8. **Colisión operativa prevista**: la línea de CH-2 («No preguntó por el cinturón.», tabla 5.1 cap-41) cae de forma natural dentro de `S40-locutorio` (107–123). Insertar fuera del span (40:127) o rebaseline con gate — decisión de A0 antes de W5.
...
| 5 | «Maja condujo con la credencial apagada en el hueco junto al freno y la huella de las uñas aún marcada en la palma.» | cap-25.md:219 | fichero íntegro |
| 6 | «Las cifras rojas conservaron los cuatro minutos que el corte les había quitado.» | cap-29.md:307 | fichero íntegro |
| 7 | «La puerta rozó una vez más antes de cerrar.» | cap-49.md:109 | fichero íntegro (citado por la crítica) |
...
| 11 | «El cursor permanecía inmóvil detrás de *retenida*.» | cap-23.md:89 | sin span |
| 12 | «Cuando lo soltó, volvió solo hasta la misma muesca de la madera.» | cap-24.md:77 | sin span |
| 13 | «El terminal confirmó la clase del carné vigente: `SEGURIDAD · PRESENCIA LOCAL`. Cerró la consulta sin presentarlo a un lector, lo deslizó entre los carnés caducados y cerró el broche.» | cap-30.md:217 | `S24-cierre` (plantado CH-6/16; A4 lo cuenta como tic ya decidido) |
...
| 16 | «En el centro, la fogata ajena sigue ardiendo sola.» | cap-37.md:241 | sin span (RW del 30: recomendado conservar) |
| 17 | «La bajamar había dejado al aire otra franja de madera oscura.» / «En la tableta, el quinto hueco no volvió a abrirse.» | cap-40.md:231–233 | `S33-hueco` (233) |
| 18 | «La cera endureció sobre el acero.» / «Al otro lado siguieron zumbando las bombas.» | cap-46.md:193–195 | sin span |
| 19 | «En la cena, la tarjeta quedó junto al frutero hasta que Jessie la guardó en la mochila.» | cap-47.md:127 | sin span |
...
**[W10 it.4, 2026-08-20]** `cap-36` «La asamblea» se partió en `cap-36.md` (A) y **`cap-37.md`
«Papeletas»** (B, `orden_lectura` 36,5), por un dinkus que ya estaba en v0. Todo lo que este
documento sitúa en `cap-36` a partir de «Madre abre tres casillas…» **vive hoy en `cap-37.md`**
