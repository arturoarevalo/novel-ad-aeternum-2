...
- Fase actual: **FASE 2 ENTREGADA — G-A1 PENDIENTE DE DECISIÓN DEL AUTOR** (`informes/g-a1-gate.md`; 47 OT en `ordenes/`, `ordenes/RESERVA.md`, `informes/f2-mapa-intervenciones.md`; rama `f2-plan-estructural`, NO fusionada). W1 (F0 + F1) cerrada y en `main` (G0 y G1 aprobados; decisiones en `informes/registro-gates-autor.md`). Tras la aprobación: merge → rama `w2-reescrituras` (8, 13, 30, 17, 21, 36). Criterios de aceptación: `informes/d1-diagnostico.md` §10 y cada `ordenes/OT-NN.md` §6. Checkpoint exacto en `informes/estado-proceso.md`. Actualiza esta línea al cerrar cada fase/oleada.
