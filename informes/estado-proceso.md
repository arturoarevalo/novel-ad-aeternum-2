...
- **Hallazgo mayor: M6b medía mal desde F1.** Sin ancla, el instrumento confunde «voces indiferenciadas» con «voces diferenciadas y etiquetas cambiadas». Con ancla, N2 da 86,1 % y v0 64,3 % (D1 registraba 21 %). Hay que rehacer la medición global con ancla **antes de dimensionar W4 y W6**, cuyo peso en T4 se justificaba con el número viejo.
