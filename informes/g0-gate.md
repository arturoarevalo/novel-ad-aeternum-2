...
| B6b Lista negra de clichés (A4, T5c) | `biblia/b6-lista-negra.md` + `b6-lista-negra-patrones.txt` | 45 patrones | léxica + sintáctica + sustituciones con citas de v0; checklist `grep -E -f`; hits sobre v0 bajos (1–11 por capítulo, documentados) | ✅ |
